...
public abstract class SelectFieldBase<TValue> : ContentView, ISelectField<TValue> where TValue : struct, Enum
{
	public static readonly BindableProperty LabelProperty =
		BindableProperty.Create(nameof(Label), typeof(string), typeof(SelectFieldBase<TValue>), string.Empty);
	...
	public static readonly BindableProperty OrientationProperty =
		BindableProperty.Create(nameof(Orientation), typeof(StackOrientation), typeof(SelectFieldBase<TValue>), StackOrientation.Vertical);
